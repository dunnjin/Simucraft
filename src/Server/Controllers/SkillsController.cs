...
namespace Simucraft.Server.Controllers
{
    ...
    public class SkillsController : Controller
    {
        ...
        public async Task<IActionResult> Post(Guid rulesetId, SkillRequest request)
        {
            try
            {
                var userId = base.User.GetId();
        ...
        public async Task<IActionResult> Put(Guid rulesetId, Guid id, SkillRequest request)
        {
            try
            {
                var userId = base.User.GetId();
