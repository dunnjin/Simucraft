...
{
    public class CombatPlacementStrategy : GameStateStrategy<RequestCombatPlacement>
    {
        private readonly SimucraftContext _simucraftContext;
        private readonly IMapper _mapper;

        public CombatPlacementStrategy(
        ...
        public override async Task<GameStateInformationResponse> RequestAsync(Guid gameId, Guid userId, RequestCombatPlacement request)
        {
